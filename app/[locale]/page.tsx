    ...
    <div>
      ...
      <section className="relative py-20 bg-gradient-to-r from-gray-900 via-black to-gray-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="glass rounded-3xl p-12 backdrop-blur-xl border border-white/10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="space-y-3 transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl md:text-6xl font-black bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">25+</div>
                <div className="text-sm text-gray-300">{params.locale === 'tr' ? 'Yıllık Deneyim' : 'Years Experience'}</div>
              </div>
              <div className="space-y-3 transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl md:text-6xl font-black bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">13+</div>
                <div className="text-sm text-gray-300">{params.locale === 'tr' ? 'CNC Makine' : 'CNC Machines'}</div>
              </div>
              <div className="space-y-3 transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl md:text-6xl font-black bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">100%</div>
                <div className="text-sm text-gray-300">{params.locale === 'tr' ? 'Kalite Odaklı' : 'Quality Focused'}</div>
              </div>
              <div className="space-y-3 transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl md:text-6xl font-black bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">24/7</div>
                <div className="text-sm text-gray-300">{params.locale === 'tr' ? 'Destek' : 'Support'}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          ...
          <div className="flex gap-6 justify-center flex-wrap">
            <Link 
              ...
              className="group relative px-10 py-5 overflow-hidden rounded-full bg-white text-gray-900 font-bold text-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.5)]"
            >
            ...
            <Link
              ...
              className="px-10 py-5 rounded-full border-2 border-white bg-transparent text-white font-bold text-lg transition-all duration-300 hover:bg-white hover:text-gray-900"
            >
